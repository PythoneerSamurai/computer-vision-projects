...
# data loading
RAW_DATA = ImageFolder("/kaggle/input/brain-tumor", transform=TRANSFORMS)
...
EPOCHS = 20
ACCURACY_CALCULATOR = Accuracy(task="multiclass", num_classes=3).cuda()
...
torch.save(MODEL, "brainTumor.pt")
