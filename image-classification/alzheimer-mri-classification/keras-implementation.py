...
# data loading
DATA = keras.utils.image_dataset_from_directory("/kaggle/input/augmented-alzheimer-mri-dataset/AugmentedAlzheimerDataset", image_size=(128, 128), batch_size=32)
...
MODEL_CHECKPOINT = keras.callbacks.ModelCheckpoint(filepath="alzheimer.keras", monitor="loss", save_best_only=True, mode="min", save_freq="epoch")
